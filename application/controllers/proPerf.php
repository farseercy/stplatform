...
$_SESSION['postParam']="";
$_SESSION['testResult']="";
class ProPerf extends MY_Controller {
    ...
    {   
        ...
        $this->cismarty->display(APPPATH . '/views/project/perf.tpl');   
    }
    private  function getmanagetabURL(){
    	return base_url()."index.php/proPerf/exchangeLevel/".$this->uri->segment(3);
    } 
