...
class ProConf extends MY_Controller {
    ...
    {   
        ...
        $this->cismarty->display(APPPATH . '/views/project/conf.tpl');   
    }
    private  function getmanagetabURL(){
    	return base_url()."index.php/proConf/exchangeLevel/".$this->uri->segment(3);
    } 
